...
if (isset($_POST['report_name'])) {
    $report_name = cleaner($_POST['report_name']);
}
if (isset($_POST['report_description'])) {
    $report_description = cleaner($_POST['report_description']);
}
if (isset($_POST['report_active'])) {
    $report_active = (int)$_POST['report_active'];
}
if ($report_active) {
    $report_active = 1;
}
...
if (isset($_POST['report_topic'])) {
    $report_topic = (int)$_POST['report_topic'];
}
...
if ($report_topic) {
    $body .= " | <a href=\"sortreports.php?tid=$report_topic\">" . _MD_GWREPORTS_ADMIN_REPORT_SORT . '</a>';
}
