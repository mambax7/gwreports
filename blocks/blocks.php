...
function b_gwreports_block_topic_show($options)
{
    ...
    $block  = null;
    $ourdir = basename(dirname(__DIR__));
            ...
            switch ($parm_type) {
                ...
                default: // text, liketext, date
                    ...
                    if (function_exists('mb_substr')) {
                        $parm_value = mb_substr($parm_value, 0, $parm_length, XOOPS_DB_CHARSET);
                    } else {
